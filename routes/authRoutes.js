...
router.post("/admin/agent/delete",authMiddleware(["ADMIN", "EXECUTIVE"]), authController.deleteAgent);
router.post("/admin/agent/restore",authMiddleware(["ADMIN", "EXECUTIVE"]), authController.restoreAgent);
